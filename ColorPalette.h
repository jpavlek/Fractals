...
namespace Colors
{
	...
	public:
		ColorPalette(const std::string& paletteName, const int paletteSize, const std::vector<Color>& colorPalette) noexcept;
		ColorPalette(std::string&& paletteName, const int paletteSize, std::vector<Color>&& colorPalette) noexcept;
